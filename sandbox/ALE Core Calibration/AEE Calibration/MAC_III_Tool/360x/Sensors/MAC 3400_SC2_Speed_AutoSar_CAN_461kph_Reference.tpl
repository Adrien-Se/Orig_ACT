# MAC 3400_SC2_Speed_AutoSar_CAN_461kph_Reference.tpl
# 
...
# Sensing Range:                               461
# Sensing Units:                               kph
# Digital Resolution:                          0.014063
# Resolution Units:                            kph/LSB
...
/Template
	/Parameters List
		...
		/Parameter
			...
			Float:                           1
			Default Minimum Value:           0.0140625
			Default Maximum Value:           0.0140625
			Step:                            0
			User Rights:                     Calibration
			Unit:                            km/h/LSB
			Symbol Registered:               1
