# MAC 3400_SC2_CentralZ_NXP_Thornapple_32G_Reference.tpl
# 
...
# Sensing Range:                               32
# Sensing Units:                               G
# Digital Resolution:                          0.015633
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         Thornapple_400Hz.flt
# Filter File (*.dft):                         Thornapple_MvgAvg.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.30
# TPL PTC Revision:                            $Revision: 1.1 $
# Notes:                                       Designed to uThornapple9_r5.20.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Default:                         0.015632646868
			Convertion Factor:               1
			Maximum Value:                   10000
			Minimum Value:                   0.0001
			Float:                           1
			Default Minimum Value:           0.015632646868
			Default Maximum Value:           0.015632646868
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G/LSB
			Symbol Registered:               1
