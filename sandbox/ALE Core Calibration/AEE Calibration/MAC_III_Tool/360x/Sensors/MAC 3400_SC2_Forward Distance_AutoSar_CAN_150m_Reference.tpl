# MAC 3400_SC2_Forward Distance_AutoSar_CAN_150m_Reference.tpl
# 
# Simulation Tool Version:                     MAC 3400
# Target Module:                               SC2
# Sensor Name:                                 Forward Distance
# Sensor Manufacturer:                         AutoSar
# Sensor Part #:                               CAN
# Sensing Range:                               150
# Sensing Units:                               m
# Digital Resolution:                          0.1
# Resolution Units:                            m/LSB
# Filter File (*.flt):                         none
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.21
# Notes:                                       Designed to requirements attached to IM #913585 and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Float:                           1
			Default Minimum Value:           0.1000000
			Default Maximum Value:           0.1000000
			Step:                            0
			User Rights:                     Calibration
			Unit:                            m/LSB
			Symbol Registered:               1
