# MAC 3400_SC2_PRSU4_Infineon_KP301_15Pct_Reference.tpl
# 
...
/Template
	/Parameters List
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           229.6703
			Default Maximum Value:           229.6703
			Step:                            0
			User Rights:                     Calibration
			Unit:                            %
		\Parameter
		/Parameter
			...
			Minimum Value:                   -32767
			Float:                           1
			Default Minimum Value:           -63.6364
			Default Maximum Value:           -63.6364
			Step:                            0
			User Rights:                     Calibration
			Unit:                            %
		\Parameter
