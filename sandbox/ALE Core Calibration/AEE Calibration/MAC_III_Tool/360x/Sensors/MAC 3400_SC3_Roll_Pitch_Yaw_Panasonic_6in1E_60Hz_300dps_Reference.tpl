# MAC 3400_SC3_Roll_Pitch_Yaw_Panasonic_6in1E_60Hz_300dps_Reference.tpl
# 
# Simulation Tool Version:                     MAC 3400
# Target Module:                               SC3
# Sensor Name:                                 Roll_Pitch_Yaw
# Sensor Manufacturer:                         Panasonic
# Sensor Part #:                               6in1E_60Hz
# Sensing Range:                               300
# Sensing Units:                               dps
# Digital Resolution:                          0.02
# Resolution Units:                            deg/s/LSB
# Filter File (*.flt):                         6in1E_60Hz_Rate.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.2
# TPL PTC Revision:                            $Revision: 1.1 $
# Notes:                                       Designed to VAL3_Panasonic_6in1_Sensor_EWTS5GED21_PPAP_Datasheet_ver1.01_211026(Full ver1.13).pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           1966
			Default Maximum Value:           1966
			Step:                            0
			User Rights:                     Calibration
			Unit:                            deg/s
		\Parameter
		...
		/Parameter
			...
			Float:                           1
			Default Minimum Value:           0.02
			Default Maximum Value:           0.02
			Step:                            0
			User Rights:                     Calibration
			Unit:                            deg/s/LSB
			Symbol Registered:               1
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Type:                            Digital Filter
			Filter:                          Filters/6in1E_60Hz_Rate.dft
			/Starting Criteria
				Name:                        Round To Nearest Pre Filter
			\Starting Criteria
			/Final Criteria
