# MAC 3400_SC2_CentralXY_NXP_Sycamore_1500Hz_120G_Reference.tpl
# 
# Simulation Tool Version:                     MAC 3400
# Target Module:                               SC2
# Sensor Name:                                 CentralXY
# Sensor Manufacturer:                         NXP
# Sensor Part #:                               Sycamore_1500Hz
# Sensing Range:                               120
# Sensing Units:                               G
# Digital Resolution:                          0.0625
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         Sycamore_1500Hz.flt
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.15
# Notes:                                       Designed to SMMA65XX__r11_Aug2017.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           500
			Default Maximum Value:           500
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
		...
		/Parameter
			...
			Maximum Value:                   4000
			Minimum Value:                   500
			Default Minimum Value:           4000
			Default Maximum Value:           4000
			Step:                            0
			User Rights:                     Calibration
			Unit:                            Hz
		\Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           1920
			Default Maximum Value:           1920
			Step:                            0
			User Rights:                     Calibration
			Unit:                            LSB
		\Parameter
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Filter:                          Filters/Sycamore_1500Hz.flt
			/Starting Criteria
				Name:                        Resampled for Filter
			\Starting Criteria
			/Final Criteria
