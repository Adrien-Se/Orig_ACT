# MAC 3400_SC2_Z_Bosch_SMI8xx_6G_Reference.tpl
# 
...
# Filter File (*.flt):                         SMI8xx_AccZ.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.31
...
/Template
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Type:                            Digital Filter
			Filter:                          Filters/SMI8xx_AccZ.dft
			/Starting Criteria
				Name:                        Round To Nearest Pre Filter
			\Starting Criteria
			/Final Criteria
