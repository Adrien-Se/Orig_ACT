# MAC 3400_SC2_CentralXY_NXP_Thornapple_128G_Reference.tpl
# 
# Simulation Tool Version:                     MAC 3400
# Target Module:                               SC2
# Sensor Name:                                 CentralXY
# Sensor Manufacturer:                         NXP
# Sensor Part #:                               Thornapple
# Sensing Range:                               128
# Sensing Units:                               G
# Digital Resolution:                          0.062531
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         Thornapple_400Hz.flt
# Filter File (*.dft):                         Thornapple_MvgAvg.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.19
# Notes:                                       Designed to Thornapple_r2.15.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           400
			Default Maximum Value:           400
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
		...
		/Parameter
			...
			Maximum Value:                   20000
			Minimum Value:                   500
			Default Minimum Value:           14844
			Default Maximum Value:           16406
			Step:                            781
			User Rights:                     Calibration
			Unit:                            Hz
		\Parameter
		...
		/Parameter
			...
			Default:                         0.062530581362
			Convertion Factor:               1
			Maximum Value:                   10000
			Minimum Value:                   0.0001
			Float:                           1
			Default Minimum Value:           0.062530581362
			Default Maximum Value:           0.062530581362
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G/LSB
			Symbol Registered:               1
	...
	/Criteria List
		...
		/Criterion
			...
			Description:                     Sensor moving average filter
			Convertion Factor:               1
			Unit:                            LSB
			Color:                           0x001199EE
			Crash Color:                     1
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Filter:                          Filters/Thornapple_400Hz.flt
			/Starting Criteria
				Name:                        Resampled for Filter
			\Starting Criteria
			/Final Criteria
		...
		/Preprocessor
			Name:                            Sensor Filtering - @@
			Type:                            Digital Filter
			Filter:                          Filters/Thornapple_MvgAvg.dft
			/Starting Criteria
				Name:                        Round to Nearest Pre Filter
			\Starting Criteria
			/Final Criteria
