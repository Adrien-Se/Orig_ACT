# MAC 3400_SC2_CentralXY_Bosch_SMA660_120G_Reference.tpl
# 
...
# Filter File (*.flt):                         SMA660.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.3
# Notes:                                       Designed to TCD_SMA660_v2_0.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           3726.527
			Default Maximum Value:           3726.527
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
