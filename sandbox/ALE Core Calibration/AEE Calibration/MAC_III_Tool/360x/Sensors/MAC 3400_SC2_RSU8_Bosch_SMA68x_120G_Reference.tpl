# MAC 3400_SC2_RSU8_Bosch_SMA68x_120G_Reference.tpl
# 
...
# Sensing Range:                               120
# Sensing Units:                               G
# Digital Resolution:                          0.25
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         SMA68x.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.11
# Notes:                                       Designed to TCD_SMA68x_69x_v2_0.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           13729.31
			Default Maximum Value:           13729.31
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
		...
		/Parameter
			...
			Float:                           1
			Default Minimum Value:           0.25
			Default Maximum Value:           0.25
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G/LSB
			Symbol Registered:               1
