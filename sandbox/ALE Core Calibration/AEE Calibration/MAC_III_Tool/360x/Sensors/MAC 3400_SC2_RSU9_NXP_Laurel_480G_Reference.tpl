# MAC 3400_SC2_RSU9_NXP_Laurel_480G_Reference.tpl
# 
...
# Filter File (*.flt):                         Laurel_400Hz_3Pole.flt
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.33
# TPL PTC Revision:                            $Revision: 1.2 $
# Notes:                                       Designed to uLaurel9_r5.15.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
	...
	/Test
		Name:                                @@
		/Graph
			Name:                            Input Sample Rate and Filtering Panel
			Type:                            Scatter Graph
			X Title:                         Time (ms)
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Filter:                          Filters/Laurel_400Hz_3Pole.flt
			/Starting Criteria
				Name:                        Resampled for Filter
			\Starting Criteria
			/Final Criteria
