# MAC 3400_SC2_XY_Bosch_SMI8xx_6G_Reference.tpl
# 
...
# Filter File (*.flt):                         SMI8xx_AccXY.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.23
# Notes:                                       Designed to 191127_TCD_SMI8_V2_0_VNE.pdf and tested (not validated)
#
/Template
	/Parameters List
		/Parameter
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           35
			Default Maximum Value:           35
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Type:                            Digital Filter
			Filter:                          Filters/SMI8xx_AccXY.dft
			/Starting Criteria
				Name:                        Round To Nearest Pre Filter
			\Starting Criteria
			/Final Criteria
