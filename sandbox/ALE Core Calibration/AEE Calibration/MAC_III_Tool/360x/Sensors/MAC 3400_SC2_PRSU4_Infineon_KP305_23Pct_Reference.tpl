# MAC 3400_SC2_PRSU4_Infineon_KP305_23Pct_Reference.tpl
# 
...
# Filter File (*.flt):                         KP305.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.25
# Notes:                                       Designed to KP305_2 Infineon-KP305-DS-v1_20-EN_SQP3Dec2020.pdf and tested and validated
#
# PTC $Revision: 1.1 $
#
/Template
	/Parameters List
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           515.3846
			Default Maximum Value:           515.3846
			Step:                            0
			User Rights:                     Calibration
			Unit:                            %
		\Parameter
		/Parameter
			...
			Minimum Value:                   -32767
			Float:                           1
			Default Minimum Value:           -72.3571
			Default Maximum Value:           -72.3571
			Step:                            0
			User Rights:                     Calibration
			Unit:                            %
		\Parameter
