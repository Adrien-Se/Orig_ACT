# MAC 3400_SC2_RSU9_NXP_Thornapple_120G_Reference.tpl
# 
...
# Sensing Range:                               120
# Sensing Units:                               G
# Digital Resolution:                          0.25013
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         Thornapple_800Hz.flt
# Filter File (*.dft):                         Thornapple_MvgAvg.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.20
...
/Template
	/Parameters List
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           1500
			Default Maximum Value:           1500
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
		...
		/Parameter
			...
			Default:                         0.250125062531
			Convertion Factor:               1
			Maximum Value:                   10000
			Minimum Value:                   0.0001
			Float:                           1
			Default Minimum Value:           0.250125062531
			Default Maximum Value:           0.250125062531
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G/LSB
			Symbol Registered:               1
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Filter:                          Filters/Thornapple_800Hz.flt
			/Starting Criteria
				Name:                        Resampled for Filter
			\Starting Criteria
			/Final Criteria
