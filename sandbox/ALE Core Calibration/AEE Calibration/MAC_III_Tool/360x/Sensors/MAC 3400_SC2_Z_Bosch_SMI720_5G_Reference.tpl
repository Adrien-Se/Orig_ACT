# MAC 3400_SC2_Z_Bosch_SMI720_5G_Reference.tpl
# 
...
# Filter File (*.flt):                         SMI720_AccZ.dft
...
/Template
	/Parameters List
		/Parameter
			...
			Minimum Value:                   -7
			Float:                           1
			Default Minimum Value:           0.93
			Default Maximum Value:           1.07
			Step:                            0.07
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Type:                            Digital Filter
			Filter:                          Filters/SMI720_AccZ.dft
			/Starting Criteria
				Name:                        Round To Nearest Pre Filter
			\Starting Criteria
			/Final Criteria
