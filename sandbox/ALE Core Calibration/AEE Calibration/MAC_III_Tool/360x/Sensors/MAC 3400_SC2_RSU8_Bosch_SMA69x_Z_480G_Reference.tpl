# MAC 3400_SC2_RSU8_Bosch_SMA69x_Z_480G_Reference.tpl
# 
# Simulation Tool Version:                     MAC 3400
# Target Module:                               SC2
# Sensor Name:                                 RSU8
# Sensor Manufacturer:                         Bosch
# Sensor Part #:                               SMA69x_Z
# Sensing Range:                               480
# Sensing Units:                               G
# Digital Resolution:                          1
# Resolution Units:                            G/LSB
# Filter File (*.flt):                         SMA69x.dft
# Data Format:                                 Reference
# MAC III SC2 Sensor Templates.xlsx MKS Rev:   1.9
...
/Template
	/Parameters List
		...
		/Parameter
			...
			Minimum Value:                   0
			Float:                           1
			Default Minimum Value:           15690.64
			Default Maximum Value:           15690.64
			Step:                            0
			User Rights:                     Calibration
			Unit:                            G
		\Parameter
