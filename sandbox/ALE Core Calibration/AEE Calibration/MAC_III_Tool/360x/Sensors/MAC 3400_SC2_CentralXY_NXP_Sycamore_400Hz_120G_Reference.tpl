...
/Template
	...
	/Preprocessors List
		...
		/Preprocessor
			...
			Filter:                          Filters/Sycamore_400Hz.flt
			/Starting Criteria
				Name:                        Resampled for Filter
			\Starting Criteria
			/Final Criteria
